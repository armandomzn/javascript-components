export const data = [
  {
    ...
    activities: [
      ...
      "Cupcake muffin danish muffin cookie gummies. Jelly beans tiramisu pudding. Toffee soufflé chocolate cake pastry brownie. Oat cake halvah sweet roll cotton candy croissant lollipop. Macaroon tiramisu chocolate bar candy candy carrot cake jelly sweet. Gummies croissant macaroon dessert. Chocolate cake dragée pie.",
    ],
  },
  {
    id: "mYq3t6w9",
    title: "web developer",
    date: "January 2020 - Juin 2020 ",
    company: "Ryan-Kiehn",
    order: 2,
    activities: [
  ...
  },
  {
    id: "gUkXp2s5",
    title: "product owner",
    date: "February 2022 - Actual",
    company: "Metz, Davis and Green",
    order: 4,
    activities: [
      "elly bear claw gummi bears lollipop cotton candy gummi bears chocolate bar cake cookie. Cupcake muffin danish muffin cookie gummies. Jelly beans tiramisu pudding",
